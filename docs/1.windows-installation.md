...
2. Put them into the `stable-diffusion-webui/models/realesrgan` directory. 
...
4. Wait until it is done and you can confirm by confirming two new files in `stable-diffusion-webui/models/ldsr/`
...
6. Rename last.ckpt to model.ckpt and place both under `stable-diffusion-webui/models/ldsr/`.
7. Refer to [here](https://github.com/Sygil-Dev/stable-diffusion-webui/issues/488) for any issue.
