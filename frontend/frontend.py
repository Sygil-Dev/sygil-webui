    ...
    with gr.Blocks(css=css(opt), analytics_enabled=False, title="Stable Diffusion WebUI") as demo:
        with gr.Tabs(elem_id='tabss') as tabs:
                ...
                with gr.Row(elem_id='body').style(equal_height=False):
                    with gr.Column():
                        ...
                        txt2img_cfg = gr.Slider(minimum=-40.0, maximum=30.0, step=0.5,
                                                label='Classifier Free Guidance Scale (how strongly the image should '
                                                      'follow the prompt)',
                        ...
                        with gr.Tabs():
                            ...
                            with gr.TabItem('Advanced'):
                                ...
                                txt2img_batch_size = gr.Slider(minimum=1, maximum=8, step=1,
                                                               label='Batch size (how many images are in a batch; '
                                                                     'memory-hungry)',
                                ...
                                txt2img_realesrgan_model_name = gr.Dropdown(label='RealESRGAN model',
                                                                            ...
                                                                            visible=False)  # RealESRGAN is not None
                                # invisible until removed)  # TODO: Feels like I shouldnt slot it in here.
            ...
            with gr.TabItem("Image-to-Image Unified", id="img2img_tab"):
                ...
                img2img_inputs = [img2img_prompt, img2img_image_editor_mode, img2img_image_editor, img2img_image_mask,
                                  img2img_mask,
