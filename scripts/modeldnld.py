...
class Models:
    ...
    def realESRGAN():
        if op.exists('models/realesrgan/experiments/pretrained_models/RealESRGAN_x4plus.pth') and op.exists('models/realesrgan/experiments/pretrained_models/RealESRGAN_x4plus_anime_6B.pth'):
            ...
            os.system('curl -L https://huggingface.co/kaliansh/sdrep/resolve/main/RealESRGAN_x4plus.pth -o models/realesrgan/experiments/pretrained_models/RealESRGAN_x4plus.pth')
            os.system('curl -L https://huggingface.co/kaliansh/sdrep/resolve/main/RealESRGAN_x4plus_anime_6B.pth -o models/realesrgan/experiments/pretrained_models/RealESRGAN_x4plus_anime_6B.pth')
            return st.write(f"ESRGAN upscaler installed successfully !")

    # GFPGANv1.3
    def GFPGAN():
        if op.exists('models/gfpgan/experiments/pretrained_models/GFPGANv1.4.pth'):
            return st.write(f"GFPGAN already exists !")
        else:
            os.system(
                'curl -L https://huggingface.co/kaliansh/sdrep/resolve/main/GFPGANv1.4.pth -o models/gfpgan/experiments/pretrained_models/GFPGANv1.4.pth')
            return st.write(f"GFPGAN installed successfully !")

    # Latent Diffusion
    def modelLD():
        if op.exists('models/latent-diffusion/experiments/pretrained_models/model.ckpt'):
            ...
            os.mkdir('models/ldsr/experiments/pretrained_models')
            st.write(f"Github Repository cloned !")
            os.system(
                'curl -o models/ldsr/experiments/pretrained_models/project.yaml -L https://huggingface.co/kaliansh/letentDiff/resolve/main/project.yaml')
            ...
            os.system(
                'curl -o models/ldsr/experiments/pretrained_models/model.ckpt -L https://huggingface.co/kaliansh/letentDiff/resolve/main/model.ckpt')
